...
# -*- coding: utf-8 -*-
"""
Created on Sun May 21 20:30:37 2023
...
class Game():
    ...
    def get_flag(self):
        """
        Función de la clase Game que devuelve la primera bandera visible
...
def main():
    ...
    """
    try:
        with Client((sys.argv[1], 5000), authkey=b'secret password') as conn:
            game = Game()
            n = conn.recv()
